"""
Download and clip SRTM 30m DEM using an AOI shapefile.

This script downloads a 30-meter resolution DEM (SRTMGL1) from
...
SHAPEFILE_PATH = "../../DATA/shapefiles/"      # AOI shapefile path
OUTPUT_DEM_PATH = "../../DATA/DEM_prep/SRTM_30m_DEM.tif"  # Output DEM file
DEM_TYPE = "SRTMGL1"                                 # DEM type (30m)
TEMP_FILE = "temp_30m.tif"                           # Temporary local file
...
def main():
    ...
    print("🔄 Downloading SRTM 30m DEM from OpenTopography...")
